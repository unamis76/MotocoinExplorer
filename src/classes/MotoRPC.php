<?php
	class MotoRPC {
		...
		******************************************************************************/
		...
		private static function wallet_fetch ($request_array)
		{
		...
		public static function getpeerinfo()
		{
			...
			$info = self::wallet_fetch ($request_array);
	
			return ($info);
		}	
		
		public static function getblock ($block_hash)
		{
		//	The JSON-RPC request starts with a method name
		...
		public static function getblockhash ($block_index)
		{
		//	The JSON-RPC request starts with a method name
		...
		public static function getnetworkhashps ($block_index=NULL)
		{
		//	The JSON-RPC request starts with a method name
		...
		public static function getrawtransaction ($tx_id, $verbose=1)
		{
		//	The JSON-RPC request starts with a method name
